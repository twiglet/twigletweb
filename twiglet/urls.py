...
urlpatterns = patterns('',
    ...
    (r'^download_thanks_thanks/$', 'webapp.views.download_thanks_thanks'),
    (r'^download_release/$', 'webapp.views.download_release'),
    ...
    (r'^showcase/code_license_mit/$', 'webapp.views.showcase_license_mit'),
    (r'^showcase/code_license_sestoft/$', 'webapp.views.showcase_license_sestoft'),
    (r'^documentation/$', 'webapp.views.cs2jdocumentation'),
    (r'^forums/$', 'webapp.views.forums'),
    (r'^privacy/$', 'webapp.views.privacy_policy'),
    (r'^$', 'webapp.views.home'),
